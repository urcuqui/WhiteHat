...
# this is a pretty hex dumping directly taken from the example book and this is taken from
...
def proxy_handler(client_socket, remote_host, remote_port, receive_first):
    ...
    # receive data from the remote end if it is necessary
    if receive_first:
        ...
        # if we have data to send to our local clinet,sent it:
        ...
        while True:
            ...
            if len(local_buffer):
                ...
                # send off the data to th remote host
                remote_socket.send(local_buffer)
                print("[==>] send to the remote")
