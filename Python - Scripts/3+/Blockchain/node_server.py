# Reference: https://github.com/satwikkansal/python_blockchain_app/blob/master/node_server.py
# Modified by: Christian Urcuqui
...
class Block:
    def __init__(self, index, transactions, timestamp, previous_hash):
        ...
        # nonce is a number that is going to change until the hash is going to be correct
        self.nonce = 0
...
class BlockChain:
    ...
    def check_chain_validity(cls, chain):
        ...
        for block in chain:
            ...
            return result
        """
        All transactions initially are saved 
        """
